...
fn suppress_table_underlines(
    ...
    // Table detection disabled in wasm-doc-boost fork.
    // Underlines in table cells remain — extraction is correct,
    // just without the cosmetic underline suppression.
}
...
mod tests {
    ...
    #[test]
    #[ignore = "table underline suppression disabled in wasm-doc-boost fork"]
